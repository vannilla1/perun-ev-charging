...
import { UserIcon, CreditCardIcon, BellIcon, CogIcon, QuestionIcon, LogoutIcon, BoltIcon, LoginIcon } from '@/components/Common';
    ...
    >
      ...
      >
        ...
        <Card style={{ marginBottom: '32px' }}>
          <CardContent>
            <div className="flex items-center gap-4">
              ...
              <Link href="/profile/edit" className="p-2 hover:bg-[var(--surface-secondary)] rounded-full transition-colors">
        ...
        <Card className="overflow-hidden" padding="none" style={{ marginBottom: '20px' }}>
          <MenuItem icon={<UserIcon />} label={t('personalInfo')} href="/profile/edit" />
          <div className="border-t border-[var(--border-light)]" />
          <MenuItem icon={<CreditCardIcon />} label={t('paymentMethods')} value={isDemoAccount ? 'Visa •••• 1234' : undefined} href="/payment-methods" />
          <div className="border-t border-[var(--border-light)]" />
          <MenuItem icon={<BellIcon />} label={t('notifications')} href="/settings" />
          <div className="border-t border-[var(--border-light)]" />
          <MenuItem icon={<CogIcon />} label={t('settings')} href="/settings" />
        </Card>

        <Card className="overflow-hidden" padding="none">
          <MenuItem icon={<QuestionIcon />} label={t('help')} href="/settings" />
          <div className="border-t border-[var(--border-light)]" />
          <MenuItem
            icon={<LogoutIcon />}
            label={t('logout')}
